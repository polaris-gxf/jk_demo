...
<li id="new"><a href="/cargo/contract/jOutProduct.jsp">出货表</a></li>
...
<li id="new"><a href="#" onclick="formSubmit('/contract/contractAction_copy','_self');this.blur();">复制</a></li>
...
<div>
	...
	<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="98%" >
		...
		<tr class="odd"  onmouseover="this.className='highlight'"  onmouseout="this.className='odd'" >
			...
			<td>
				<s:property value="#dl.contractProducts.size()"/>
				/
				<s:set name="extNumber" value="0"/><!-- 初始化 -->
				<s:iterator value="#dl.contractProducts" var="cp">
					<s:set name="extNumber" value="#extNumber+#cp.extCproducts.size()"/>	<!-- 累计 -->
				</s:iterator>
			...
			<td>${totalAmount}</td>
			<td>
				<s:if test="state==0"><font color="green">草稿</font></s:if>
				<s:if test="state==1">已上报待报运</s:if>
			</td>
			<td>
