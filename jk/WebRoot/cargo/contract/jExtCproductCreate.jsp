...
<form name="icform" method="post">
	...
	<input type="text" name="contractProduct.id" value="${contractProduct.id}"/><!-- 传递货物的ID -->
...
附件信息列表
	...
	<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="98%" >
		...
		<tr class="odd"  onmouseover="this.className='highlight'"  onmouseout="this.className='odd'" >
			...
			<td>${amount}</td>
			<td>
				[<a href="extCproductAction_toupdate?id=${id}&contractProduct.id=${contractProduct.id}">修改</a>]
				[<a href="extCproductAction_delete?id=${id}&contractProduct.id=${contractProduct.id}">删除</a>]
			</td>
		</tr>
		</s:iterator>
		</tbody>
