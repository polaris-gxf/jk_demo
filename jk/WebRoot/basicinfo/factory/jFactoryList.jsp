...
<li id="new"><a href="#" onclick="formSubmit('/basicinfo/factoryAction_export','_self');this.blur();">导出</a></li>
</ul>
    </div>
</div>
</div>
...
<div>
	...
	<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="98%" >
		...
		<tr class="odd"  onmouseover="this.className='highlight'"  onmouseout="this.className='odd'" >
			...
			<td>${mobile}</td>
			<td>
				<s:if test="state==1"><a href="factoryAction_stop?id=${id}">启用</a></s:if>
				<s:if test="state==0"><a href="factoryAction_start?id=${id}"><font color="red">停用</font></a></s:if>
			</td>
		</tr>
		</s:iterator>
